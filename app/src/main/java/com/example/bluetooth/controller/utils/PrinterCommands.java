package com.example.bluetooth.controller.utils;
...
public class PrinterCommands {
    ...
    public static final byte[] getFormatBold() {
    ...
    public static final byte[] getFormatHeigth() {
        byte[] arrayOfByte1 = {27, 33, 0};
        byte[] format = {27, 33, 0};
        // Height
    ...
    public static byte[] getFormatWidth() {
        byte[] arrayOfByte1 = {27, 33, 0};
        byte[] format = {27, 33, 0};
        // Width
    ...
    public static byte[] getFormatUnderline() {
        byte[] arrayOfByte1 = {27, 33, 0};
        byte[] format = {27, 33, 0};
        // Underline
    ...
    public static byte[] getFormatSmall() {
        byte[] arrayOfByte1 = {27, 33, 0};
        byte[] format = {27, 33, 0};
        // Small
